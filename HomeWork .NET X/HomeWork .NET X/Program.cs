...
using Training3.Training3;
using Training3.Training3.Task3;
...
namespace HomeWork_.NET_X
{
    ...
    class Program
    {
        static void Main(string[] args)
        {
            ...
            #region Inheritance Task1
            TaskRectangleAbstract rect = new TaskRectangleAbstract();
            TaskSqaureAbstract sqr = new TaskSqaureAbstract();
            rect.Show();
            sqr.Show();
            Console.WriteLine("1------");
            #endregion

            #region Inheritance Task2
            TaskRectangleAbstract rect2 = new TaskRectangleAbstract(4, 7);
            TaskSqaureAbstract sqr2 = new TaskSqaureAbstract(4, 8);
            Console.WriteLine("2------");
            #endregion

            #region Inheritance Task3
            Task3FigureVirtual fig = new Task3FigureVirtual();
            Task3RectangleVirtual rectangle = new Task3RectangleVirtual();
            Task3SqaureVirtual squre = new Task3SqaureVirtual();
            fig.Draw();
            rectangle.Draw();
            squre.Draw();
            Console.WriteLine("3------");
            ...
            #region Inheritance Task4

            Task4RectangleWithInterface rect4 = new Task4RectangleWithInterface();
            Task4SqaureWithInterface sqr4 = new Task4SqaureWithInterface();
            DrawAll(rect4, sqr4);
            Console.WriteLine("4------");
            #endregion
        ...
        static void DrawAll(params IDrawable[] arr)
        {
